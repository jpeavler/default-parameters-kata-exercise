...
describe('Default parameters make function parameters more flexible', () => {
  ...
  it('it can also be a function', function() {
    const defaultValue = () => 'defaultValue';  //changed defaultValue into function
